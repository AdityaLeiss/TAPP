...
class DosensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dosen" do
    assert_difference('Dosen.count') do
      post dosens_url, params: { dosen: { email: @dosen.email, nama: @dosen.nama, nip: @dosen.nip, password: @dosen.password, username: @dosen.username } }
    end
  ...
  test "should update dosen" do
    patch dosen_url(@dosen), params: { dosen: { email: @dosen.email, nama: @dosen.nama, nip: @dosen.nip, password: @dosen.password, username: @dosen.username } }
